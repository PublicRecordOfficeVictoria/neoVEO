...
class RepnHistory extends RepnXML {
    private static final String CLASSNAME = "RepnHistory";
    private RepnItem version; // version identifier of this VEOHistory.xml file
    private ArrayList<RepnEvent> events;    // list of events associated with this history
