...
class RepnFile extends Repn {
    ...
    public RepnFile(Path file, Path veoDir, HashMap<Path, RepnFile> contentFiles, ResultSummary results) throws VEOError {
        ...
        if (!Files.exists(file)) {
            throw new VEOError(errMesg(classname, "Content directory '" + file.toString() + "' does not exist."));
        }
    ...
    public final void validate() throws VEOError {
        ...
        if (!isDirectory) {
            if (rcf == null) {
                addWarning("This file is not referenced in the VEOContent.xml file");
            }
    ...
    public String getErrors() {
        ...
        for (i = 0; i < children.size(); i++) {
            sb.append(children.get(i).getErrors());
        }
        return sb.toString();
    }
    ...
    /**
     * Build a list of all of the warnings generated by this File
     *
     * @return String containing the concatenated error list
     */
    @Override
    public String getWarnings() {
        ...
        for (i = 0; i < children.size(); i++) {
            sb.append(children.get(i).getWarnings());
        }
        return sb.toString();
    }
